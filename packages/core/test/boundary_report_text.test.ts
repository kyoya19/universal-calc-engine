...
describe('boundary report text helpers', () => {
  ...
  it('formats empty row and empty sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'empty_row_empty_sections',
      title: 'Empty Row Empty',
      sections: [
        { id: 'empty', title: 'Empty', rows: [] },
        { id: 'middle', title: 'Middle', rows: [{ id: 'middle-row', label: 'middle', plainText: 'middle: 2' }] },
        { id: 'tail', title: 'Tail', rows: [] }
      ]
    };

    expect(formatReportModelsPlainText([report])).toBe('Empty Row Empty\n\n## Empty\n\n## Middle\nmiddle: 2\n\n## Tail');
  });

  it('formats empty row and row sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'empty_row_row_sections',
      title: 'Empty Row Row',
      sections: [
        { id: 'empty', title: 'Empty', rows: [] },
        { id: 'middle', title: 'Middle', rows: [{ id: 'middle-row', label: 'middle', plainText: 'middle: 2' }] },
    ...
    expect(formatReportModelsPlainText([report])).toBe('Empty Row Row\n\n## Empty\n\n## Middle\nmiddle: 2\n\n## Last\nlast: 3');
  });

  it('formats empty empty and empty sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'empty_empty_empty_sections',
      title: 'Empty Empty Empty',
      sections: [
        { id: 'first', title: 'First', rows: [] },
        { id: 'second', title: 'Second', rows: [] },
        { id: 'third', title: 'Third', rows: [] }
      ]
    };

    expect(formatReportModelsPlainText([report])).toBe('Empty Empty Empty\n\n## First\n\n## Second\n\n## Third');
  });

  it('formats empty empty and row sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'empty_empty_row_sections',
      title: 'Empty Empty Row',
      sections: [
        { id: 'first', title: 'First', rows: [] },
        { id: 'second', title: 'Second', rows: [] },
        { id: 'last', title: 'Last', rows: [{ id: 'last-row', label: 'last', plainText: 'last: 3' }] }
    ...
    expect(formatReportModelsPlainText([report])).toBe('Empty Empty Row\n\n## First\n\n## Second\n\n## Last\nlast: 3');
  });
  ...
  it('formats row empty and empty sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'row_empty_empty_sections',
      title: 'Row Empty Empty',
      sections: [
        { id: 'first', title: 'First', rows: [{ id: 'first-row', label: 'first', plainText: 'first: 1' }] },
        { id: 'middle', title: 'Middle', rows: [] },
        { id: 'last', title: 'Last', rows: [] }
      ]
    };

    expect(formatReportModelsPlainText([report])).toBe('Row Empty Empty\n\n## First\nfirst: 1\n\n## Middle\n\n## Last');
  });

  it('formats row row and empty sections with stable section gaps', () => {
    const report: ReportModel = {
      kind: 'row_row_empty_sections',
      title: 'Row Row Empty',
      sections: [
        { id: 'first', title: 'First', rows: [{ id: 'first-row', label: 'first', plainText: 'first: 1' }] },
  ...
  it('formats title-section-empty report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_title_only',
        title: 'First Title',
      ...
      },
      {
        kind: 'middle_section',
        title: 'Middle Section',
        sections: [{ id: 'summary', title: 'Summary', rows: [{ id: 'middle-row', label: 'middle', plainText: 'middle: 2' }] }]
      },
      {
  ...
  it('formats title-section-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_title_only',
        title: 'First Title',
      ...
      },
      {
        kind: 'last_section',
        title: 'Last Section',
        sections: [{ id: 'details', title: 'Details', rows: [{ id: 'last-row', label: 'last', plainText: 'last: 3' }] }]
      }
    ];
  ...
  it('formats section-empty-title report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-empty-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-empty-empty report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-title-empty report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-title-title report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-section-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
      ...
      },
      {
        kind: 'middle_section',
        title: 'Middle Section',
        sections: [{ id: 'details', title: 'Details', rows: [{ id: 'middle-row', label: 'middle', plainText: 'middle: 2' }] }]
      },
      {
        kind: 'last_section',
        title: 'Last Section',
        sections: [{ id: 'tail', title: 'Tail', rows: [{ id: 'last-row', label: 'last', plainText: 'last: 3' }] }]
      }
    ];
  ...
  it('formats section-section-title report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats section-section-empty report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_section',
        title: 'First Section',
  ...
  it('formats title-empty-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_title_only',
        title: 'First Title',
  ...
  it('formats title-title-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_title_only',
        title: 'First Title',
      ...
      },
      {
        kind: 'last_section',
        title: 'Last Section',
        sections: [{ id: 'summary', title: 'Summary', rows: [{ id: 'last-row', label: 'last', plainText: 'last: 2' }] }]
      }
    ];
  ...
  it('formats empty-section-title report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_empty_section',
        title: 'First Empty',
  ...
  it('formats empty-section-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_empty_section',
        title: 'First Empty',
  ...
  it('formats empty-section-empty report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_empty_section',
        title: 'First Empty',
  ...
  it('formats empty-title-title report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_empty_section',
        title: 'First Empty',
  ...
  it('formats empty-title-section report models with stable separators', () => {
    const reports: ReportModel[] = [
      {
        kind: 'first_empty_section',
        title: 'First Empty',
